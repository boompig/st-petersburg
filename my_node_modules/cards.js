...
var cards = {
    ...
    library: new Card("Library", 17, 0, 5, Card.types.BUILDING),
    theatre: new Card("Theatre", 20, 0, 6, Card.types.BUILDING),
    academy: new Card("Academy", 23, 0, 7, Card.types.BUILDING),
};
