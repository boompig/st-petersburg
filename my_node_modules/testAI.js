...
exports.testWaitWithIncome = function (test) {
    ...
    test.strictEqual(obj.score, cards.firehouse.pointYield, "slow buy firehouse - points");
...
exports.testAcademyWithIncomeTwoDeep = function (test) {
    ...
    test.strictEqual(obj.score, cards.academy.pointYield * 2 + cards.market.pointYield, "buy academy first - points");
...
exports.testAcademyWideTwoDeep = function (test) {
    ...
    //for (var i = 0; i < obj.moveList.length; i++) {
        //console.log(obj.moveList[i].toString());
    //}
    //console.log("Processed " + obj.numNodes + " states");

    test.strictEqual(obj.score, cards.academy.pointYield * 2 + cards.market.pointYield,
...
exports.testAcademyThreeDeep = function (test) {
    ...
    test.strictEqual(obj.score, cards.academy.pointYield * 3 + cards.firehouse.pointYield,
            "buy academy first - points");
    test.ok(correctBestMove.equals(obj.moveList[0]) ||
            correctBestMove.equals(obj.moveList[1]), "buy academy first - action");
    test.done();
...
exports.testAcademyFourDeep = function (test) {
    ...
    test.strictEqual(obj.score,
        cards.academy.pointYield * 4 + cards.firehouse.pointYield * 2 + cards.market.pointYield,
        "buy academy first - points");
    test.ok(correctBestMove.equals(obj.moveList[0]) ||
